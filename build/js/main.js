...
function getFighters() {
    ...
    const PIRAHNA_PLANT = new Character(70, 'Piranha Plant', 'Super Mario Bros.', 'pirahna-plant.png', 'Piranha Plant Pipes Up!', '<iframe width="560" height="315" src="https://www.youtube.com/embed/3sZsk8VHY2g" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>', 'mario');
    const JOKER = new Character(71, 'Joker', 'Persona 5', 'joker.png', 'Joker steals the show when he joins the Super Smash Bros.™ Ultimate game as a playable fighter! This speedy fighter from the Persona series wields a knife and a gun to rack up damage. When his Rebellion Gauge is full, Joker summons his Persona, Arsene, to immediately power up his attacks for a limited time. This pack also includes Mementos, a stage that changes colors, depending on which Persona series music track is playing!', '<iframe width="560" height="315" src="https://www.youtube.com/embed/W4PG9qx9x2s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>', 'persona');
    const HERO = new Character(72, 'Hero', 'Dragon Quest XI', 'hero.png', 'The Hero from the DRAGON QUEST® XI game joins Super Smash Bros.™ Ultimate as a playable fighter! Wielding the Supreme Sword of Light and a trusty shield, he can slice his foes and block incoming attacks. When Hero pulls up his Command Selection screen, he’ll have access to a random selection of spells that could turn the tide of battle in his favor! This pack also includes the Yggdrasil’s Altar stage, which sweeps across nearby areas around the sacred Tree of Life, as well as a selection of music from the DRAGON QUEST series.', '<iframe width="560" height="315" src="https://www.youtube.com/embed/pupll3ON-WA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>', 'hero');
